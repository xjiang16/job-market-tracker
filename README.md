...
Current snapshot (updated July 29, 2026): **132 postings** after deduplication.

| Tool | Mentioned in | Share |
|------|-------------:|------:|
| SQL | 24 postings | 18.2% |
| Python | 9 postings | 6.8% |
| Snowflake | 5 postings | 3.8% |
| Airflow | 4 postings | 3.0% |
| dbt | 1 posting | 0.8% |

The most notable finding is that **77.3% of postings (102 out of 132) mention none of the 5 tracked tools explicitly**.

Instead, most postings describe responsibilities in general terms such as *"build data pipelines"* or *"own the data platform"* rather than naming a specific technology stack. Of the five tracked tools, **SQL** appears most often in this sample (18.2%).
