...
Current snapshot (updated August 17, 2026): **219 postings** after deduplication.

| Tool | Mentioned in | Share |
|------|-------------:|------:|
| SQL | 35 postings | 16.0% |
| Python | 13 postings | 5.9% |
| Snowflake | 10 postings | 4.6% |
| Airflow | 4 postings | 1.8% |
| dbt | 2 postings | 0.9% |

The most notable finding is that **79.9% of postings (175 out of 219) mention none of the 5 tracked tools explicitly**.
