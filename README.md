...
Current snapshot (updated August 06, 2026): **177 postings** after deduplication.

| Tool | Mentioned in | Share |
|------|-------------:|------:|
| SQL | 24 postings | 13.6% |
| Python | 9 postings | 5.1% |
| Snowflake | 5 postings | 2.8% |
| Airflow | 4 postings | 2.3% |
| dbt | 2 postings | 1.1% |

The most notable finding is that **82.5% of postings (146 out of 177) mention none of the 5 tracked tools explicitly**.

Instead, most postings describe responsibilities in general terms such as *"build data pipelines"* or *"own the data platform"* rather than naming a specific technology stack. Of the five tracked tools, **SQL** appears most often in this sample (13.6%).
