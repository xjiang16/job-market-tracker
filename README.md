...
Current snapshot (updated September 16, 2026): **323 postings** after deduplication.

| Tool | Mentioned in | Share |
|------|-------------:|------:|
| SQL | 38 postings | 11.8% |
| Python | 18 postings | 5.6% |
| Databricks | 17 postings | 5.3% |
| Snowflake | 16 postings | 5.0% |
| Spark | 14 postings | 4.3% |
| AWS | 10 postings | 3.1% |
| dbt | 5 postings | 1.5% |
...
The most notable finding is that **75.9% of postings (245 out of 323) mention none of the 16 tracked tools explicitly**.

Instead, most postings describe responsibilities in general terms such as *"build data pipelines"* or *"own the data platform"* rather than naming a specific technology stack. Of the 16 tracked tools, **SQL** appears most often in this sample (11.8%).
