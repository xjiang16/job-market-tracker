...
Current snapshot (updated August 21, 2026): **232 postings** after deduplication.

| Tool | Mentioned in | Share |
|------|-------------:|------:|
| SQL | 36 postings | 15.5% |
| Python | 13 postings | 5.6% |
| Snowflake | 10 postings | 4.3% |
| Airflow | 4 postings | 1.7% |
| dbt | 3 postings | 1.3% |

The most notable finding is that **80.2% of postings (186 out of 232) mention none of the 5 tracked tools explicitly**.

Instead, most postings describe responsibilities in general terms such as *"build data pipelines"* or *"own the data platform"* rather than naming a specific technology stack. Of the five tracked tools, **SQL** appears most often in this sample (15.5%).
