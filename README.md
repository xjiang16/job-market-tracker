...
Current snapshot (updated August 16, 2026): **218 postings** after deduplication.

| Tool | Mentioned in | Share |
|------|-------------:|------:|
| SQL | 35 postings | 16.1% |
| Python | 13 postings | 6.0% |
| Snowflake | 10 postings | 4.6% |
| Airflow | 4 postings | 1.8% |
| dbt | 2 postings | 0.9% |

The most notable finding is that **79.8% of postings (174 out of 218) mention none of the 5 tracked tools explicitly**.

Instead, most postings describe responsibilities in general terms such as *"build data pipelines"* or *"own the data platform"* rather than naming a specific technology stack. Of the five tracked tools, **SQL** appears most often in this sample (16.1%).
