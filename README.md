...
Current snapshot (updated August 07, 2026): **182 postings** after deduplication.

| Tool | Mentioned in | Share |
|------|-------------:|------:|
| SQL | 28 postings | 15.4% |
| Python | 11 postings | 6.0% |
| Snowflake | 7 postings | 3.8% |
| Airflow | 4 postings | 2.2% |
| dbt | 2 postings | 1.1% |

The most notable finding is that **80.8% of postings (147 out of 182) mention none of the 5 tracked tools explicitly**.

Instead, most postings describe responsibilities in general terms such as *"build data pipelines"* or *"own the data platform"* rather than naming a specific technology stack. Of the five tracked tools, **SQL** appears most often in this sample (15.4%).
