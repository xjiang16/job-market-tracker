...
|------|-------------:|------:|
| SQL | 36 postings | 13.8% |
| Databricks | 15 postings | 5.7% |
...
The most notable finding is that **74.3% of postings (194 out of 261) mention none of the 16 tracked tools explicitly**.

Instead, most postings describe responsibilities in general terms such as *"build data pipelines"* or *"own the data platform"* rather than naming a specific technology stack. Of the 16 tracked tools, **SQL** appears most often in this sample (13.8%).
