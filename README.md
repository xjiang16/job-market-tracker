...
Current snapshot (updated July 27, 2026): **124 postings** after deduplication.

| Tool | Mentioned in | Share |
|------|-------------:|------:|
| SQL | 23 postings | 18.5% |
| Python | 8 postings | 6.5% |
| Snowflake | 4 postings | 3.2% |
| Airflow | 4 postings | 3.2% |
| dbt | 1 posting | 0.8% |

The most notable finding is that **77.4% of postings (96 out of 124) mention none of the 5 tracked tools explicitly**.

Instead, most postings describe responsibilities in general terms such as *"build data pipelines"* or *"own the data platform"* rather than naming a specific technology stack. Of the five tracked tools, **SQL** appears most often in this sample (18.5%).
